...
public interface IAppointmentService
{
    ...
    Task<IEnumerable<AppointmentResponseDto>> GetAppointmentsByDateRangeAsync(DateTime startDate, DateTime endDate);
    ...
    Task<AppointmentResponseDto?> UpdateAppointmentAsync(int id, UpdateAppointmentDto updateAppointmentDto);
