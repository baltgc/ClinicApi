        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableHours = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    LastName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PhoneNumberSecondary = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChiefComplaint = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    VitalSigns = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    PhysicalExamination = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    LabResults = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "4", null, "Nurse", "NURSE" },
                    { "5", null, "Receptionist", "RECEPTIONIST" },
